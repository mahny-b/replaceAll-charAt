...
/**
 * {@link Pattern#compile(String).replaceAll(String, String)}で制御文字を空文字に置換するよ！
 * @author mahny
 *
 */
public class SpeedCrazyPattern {

	private static Pattern pattern = Pattern.compile("\\p{Cntrl}");
	...
	public static String test(String org) {
		return pattern.matcher(org).replaceAll("");
	}
}
